  ...
  return (
    ...
    <React.Fragment>
      ...
      <div className="announcement-banner bg-[#302871] py-3">
        <a href="https://events.linuxfoundation.org/kubecon-cloudnativecon-north-america/co-located-events/argocon/?utm_source=argo&utm_medium=ribbon-banner&utm_campaign=KubeCon-CloudNativeCon-NA-2026&utm_content=hero">
